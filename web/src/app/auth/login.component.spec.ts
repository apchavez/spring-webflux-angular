...
describe('LoginComponent', () => {
  ...
  it('should navigate to /products on successful login', () => {
    ...
    component.form.setValue({ username: 'admin', password: 'DemoAdm1n#2026' });
    component.submit();

    expect(authServiceMock.login).toHaveBeenCalledWith({ username: 'admin', password: 'DemoAdm1n#2026' });
